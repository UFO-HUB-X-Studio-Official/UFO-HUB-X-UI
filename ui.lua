...
--===== UFO HUB X • Shop – V A2 (Model A V1 Base + Select Options Panel – Match Guide Lines v5) =====
-- แท็บ: Shop
-- ชื่อระบบ: "V A2 Test 🧪"
...
registerRight("Shop", function(scroll)
    ...
    local function openPanel()
        ...
        local topRatio    = 0.03  -- ดันขึ้นสูงให้ใกล้เส้นฟ้ามากๆ
        local bottomRatio = 0.02  -- ยืดลงล่างให้ใกล้เส้นขาว
        local rightMargin = 8
