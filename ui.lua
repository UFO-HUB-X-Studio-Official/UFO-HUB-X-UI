...
--===== UFO HUB X • Shop – V A2 (Model A V1 Base + Select Options Panel – Match Guide Lines v2) =====
-- แท็บ: Shop
-- ชื่อระบบ: "V A2 Test 🧪"
...
registerRight("Shop", function(scroll)
    ...
    local function openPanel()
        ...
        --------------------------------------------------------------------
        -- สัดส่วนจากรูป (เส้นแดง/ฟ้า/ขาว) – ปรับละเอียด
        --------------------------------------------------------------------
        local leftRatio   = 0.645 -- ซ้ายเกือบตรงเส้นแดง
        local topRatio    = 0.135 -- ระยะจากบน ≈ เส้นฟ้า
        local bottomRatio = 0.135 -- ระยะจากล่าง ≈ เส้นขาว
        local rightMargin = 8
