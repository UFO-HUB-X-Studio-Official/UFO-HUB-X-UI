...
--===== UFO HUB X • Shop – V A2 (Model A V1 Base + Select Options Panel – Match Guide Lines v3) =====
-- แท็บ: Shop
-- ชื่อระบบ: "V A2 Test 🧪"
...
registerRight("Shop", function(scroll)
    ...
    ------------------------------------------------------------------------
    -- Popup Panel: 🔍 Search – lock ตามเส้นแดง/ฟ้า/ขาว (เวอร์ชันจูนละเอียด)
    ------------------------------------------------------------------------
    local optionsPanel
    local clickBlocker
    ...
    local function openPanel()
        ...
        --------------------------------------------------------------------
        -- สัดส่วนจากรูป (เส้นแดง/ฟ้า/ขาว) – ปรับละเอียดรอบนี้
        --------------------------------------------------------------------
        local leftRatio   = 0.645 -- ซ้ายตรงเส้นแดงแล้ว
        local topRatio    = 0.09  -- ยกขึ้นให้ใกล้เส้นฟ้า
        local bottomRatio = 0.06  -- ดันลงให้ใกล้เส้นขาว
        local rightMargin = 8
