...
--===== UFO HUB X • Shop – V A2 (Model A V1 Base + Select Options Panel – Match Guide Lines v4) =====
-- แท็บ: Shop
-- ชื่อระบบ: "V A2 Test 🧪"
...
registerRight("Shop", function(scroll)
    ...
    local function openPanel()
        ...
        local topRatio    = 0.06  -- ยกขึ้นไปใกล้เส้นฟ้าอีก
        local bottomRatio = 0.05  -- ยืดลงล่างอีกนิดให้ชนเส้นขาว
        local rightMargin = 8
