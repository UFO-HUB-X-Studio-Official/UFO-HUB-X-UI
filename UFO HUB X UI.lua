...
do
    ...
    Glow.Size=UDim2.new(1.06,0,1.08,0); Glow.ZIndex=0
...
Header.Size=UDim2.new(1,0,0,40); Header.BackgroundColor3=BG_HEADER; Header.BorderSizePixel=0; corner(Header,10)

local Dot=Instance.new("Frame",Header)
Dot.BackgroundColor3=GREEN; Dot.Position=UDim2.new(0,14,0.5,-5); Dot.Size=UDim2.new(0,10,0,10); corner(Dot,5)
...
BtnClose.BackgroundColor3=Color3.fromRGB(200,40,40); BtnClose.Text="X"; BtnClose.Font=Enum.Font.GothamBold
