...
RunService.Heartbeat:Connect(function(dt)
	...
	if targetY and vY == 0 then
		...
		root.CFrame = CFrame.new(Vector3.new(pos.X, anchorY, pos.Z),
		                         Vector3.new(pos.X, anchorY, pos.Z) + Vector3.new(look.X,0,look.Z))
	else
